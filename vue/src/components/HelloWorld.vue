  ...
  <el-container>
    ...
    <el-container>
      <el-aside width="200px">
        <el-menu default-active="/ruleSingleResult" class="el-menu-vertical-demo" router>
          <el-menu-item index="/ruleSingleResult">
            <i class="el-icon-menu"></i>
            <span slot="title">指标权重</span>
          </el-menu-item>
          <el-menu-item index="/schemeSingleResult">
            <i class="el-icon-menu"></i>
                ...
                <div>
                  <div v-for="(slider, index) in this.ruleSliders" :key="index"
                    ...
                    <el-slider v-model="slider.value" :marks="marks" style=" width: 450px; margin-left: 3%; "
                      :format-tooltip="val => formatTooltip(val, slider)" v-if="slider.text1 != '-'" :min="-8" :max="8"
                      :step="1" show-stops />
                    <span style=" margin-left: 10%; width: 15%;" v-if="slider.text1 != '-'">{{ slider.text2 }}</span>
                ...
                <div>
                  <div v-for="(sliderRow, rowIndex) in this.schemeSliders" v-bind:key="rowIndex">
                    <div v-for="(slider, index) in sliderRow" :key="index">
                      <div><span v-if="index == 0" style="font-size: 16px; font-weight: bold;">{{ slider.node.topic + ":"
                      }}</span>
                      </div>
                      <div style="display: flex; align-items: center; margin-top: 20px;">
                        <span class="1" style="width: 10%;">{{ slider.text1 }}</span>
                        <el-slider v-model="slider.value" :marks="marks" style=" width: 450px; margin-left: 3%;"
                          :format-tooltip="val => formatTooltip(val, slider)" :min="-8" :max="8" :step="1" show-stops />
                        <span class="1" style=" margin-left: 8%; width: 10%;">{{ slider.text2 }}</span>
                      </div>
                    </div>
                    <div>
                  ...
                  <div slot="footer" class="dialog-footer" style="margin-top: 30px; margin-right: 200px; ">
                    ...
                    <el-button style="float: right; " type="primary" @click="sendSchemeSlidersToR">确认</el-button>
                  </div>
                  <div style="height: 20px;"></div>
                </div>
                <!-- </el-card> -->
